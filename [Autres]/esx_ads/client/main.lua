...
RegisterCommand('jobad', function(source, args)
	if ESX.PlayerData.job and ESX.PlayerData.job.name == 'motorcycle' then
		TriggerServerEvent('esx_ads:motorcyclead', args)
	...
	elseif ESX.PlayerData.job and ESX.PlayerData.job.name == 'burgershot' then
		TriggerServerEvent('esx_ads:burgershotad', args)
 	else
